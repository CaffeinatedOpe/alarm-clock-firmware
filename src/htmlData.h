...
<body class="centered" style="background-color: beige;">
	<button type='button'onclick='saveConfig()'>Save Settings</button><br />
	...
	<h2 style="font-family: 'Times New Roman', Times, serif;">Change volume:</h2><br />
  	<input type="range" min="1" max="100" value="50" class="slider" id="volume"><button type= 'button'
		onclick= 'updateVolume()'> Submit</button><br/>
	<button type='button'onclick='resetConfig()'>Reset Settings</button><br />
	<button type='button' onclick='simonOn()'>
		Simon On</button><br />
	...
	<a href="/alarms">To Alarms Page</a>
...
<body class="centered" style="background-color: beige;">
	...
	<button type='button' onclick='militaryOff()'>
		Military Off</button><br />
	<button type='button' onclick='soundAlarm()'>
		Sound Alarm</button><br />
